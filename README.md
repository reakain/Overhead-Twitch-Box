...
['ffmpeg', '-i', '/dev/video2', '-f', 'v4l2', '-framerate', '30', '-i', '/dev/video0', '-f', 'image2', '-loop', '1', '-pattern_type', 'none', '-i', 'current_frame.png', '-f', 'alsa', '-i', 'plughw:CARD=U0x46d0x825,DEV=0', '-filter_complex', '[1:v]colorkey=color=black:similarity=0.01[s0];[0:v][s0]overlay=eof_action=repeat[s1];[s1][2:v]overlay=eof_action=repeat[s2];[s2]split=2[s3][s4]', '-map', '[s3]', '-f', 'flv', '-b:v', '4500000', '-acodec', 'aac', '-fflags', 'nobuffer', '-flags', 'low_delay', '-flvflags', 'no_duration_filesize', '-pix_fmt', 'yuv420p', '-preset', 'ultrafast', '-tune', 'zerolatency', '-vcodec', 'libx264', 'udp://127.0.0.1:1234', '-map', '3', '-map', '[s4]', '-f', 'flv', '-b:v', '4500000', '-acodec', 'aac', '-fflags', 'nobuffer', '-flags', 'low_delay', '-flvflags', 'no_duration_filesize', '-pix_fmt', 'yuv420p', '-preset', 'ultrafast', '-tune', 'zerolatency', '-vcodec', 'libx264', 'rtmp://ingest.global-contribute.live-video.net/app/
